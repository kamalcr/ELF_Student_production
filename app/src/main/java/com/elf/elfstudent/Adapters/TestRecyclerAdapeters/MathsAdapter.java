 ...
 *
 */
public class MathsAdapter extends RecyclerView.Adapter<MathsAdapter.TestHolder> {



    private MathsAdapter.MathsAdapterCallback mCallback = null;
    private List<AllTestModels> mquestionList = null;
    private Context mContext = null;

    public MathsAdapter( MathsAdapter.MathsAdapterCallback mCallback, List<AllTestModels> mquestionList, Context mContext) {
    ...
    @Override
    public MathsAdapter.TestHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final MathsAdapter.TestHolder holder, int position) {
        ...
        holder.getViewRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCallback != null){
                    mCallback.mathsTestClicked(holder,holder.getAdapterPosition());
                }
            }
        });
    }
   ...
   public interface MathsAdapterCallback{
        void mathsTestClicked(MathsAdapter.TestHolder holder, int position);
    }
}
