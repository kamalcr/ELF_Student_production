 ...
 * The Adapter used in {@link com.elf.elfstudent.Fragments.AllTestFragment}
 *
 */
public class ScienceAdapter extends RecyclerView.Adapter<ScienceAdapter.TestHolder> {



    private ScienceAdapter.ScienceAdapterCallback mCallback = null;
    private List<AllTestModels> mquestionList = null;
    private Context mContext = null;

    public ScienceAdapter( ScienceAdapter.ScienceAdapterCallback mCallback, List<AllTestModels> mquestionList, Context mContext) {
    ...
    @Override
    public ScienceAdapter.TestHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ScienceAdapter.TestHolder holder, int position) {
        ...
        holder.getViewRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCallback != null){
                    mCallback.scienceTestClicked(holder,holder.getAdapterPosition());
                }
            }
        });
    }
   ...
   public interface ScienceAdapterCallback{
        void scienceTestClicked(ScienceAdapter.TestHolder holder, int position);
    }
}
