 ...
 */
public class ChemistryAdapter  extends RecyclerView.Adapter<ChemistryAdapter.TestHolder> {



    private ChemistryAdapter.ChemistryAdapterCallback mCallback = null;
    private List<AllTestModels> mquestionList = null;
    private Context mContext = null;

    public ChemistryAdapter( ChemistryAdapter.ChemistryAdapterCallback mCallback, List<AllTestModels> mquestionList, Context mContext) {
    ...
    @Override
    public ChemistryAdapter.TestHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ChemistryAdapter.TestHolder holder, int position) {
        ...
        holder.getViewRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCallback != null){
                    mCallback.chemistryTestClicked(holder,holder.getAdapterPosition());
                }
            }
        });
    }
    ...
    public interface ChemistryAdapterCallback{
        void chemistryTestClicked(ChemistryAdapter.TestHolder holder, int position);
    }
}